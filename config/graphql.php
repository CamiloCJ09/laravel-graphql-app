  ...
  'schemas' => [
    'default' => [
      'query' => [
        ...
        'employee' => App\GraphQL\Queries\Employee\EmployeeQuery::class,
        'employees' => App\GraphQL\Queries\Employee\EmployeesQuery::class,
        'sale' => App\GraphQL\Queries\Sale\SaleQuery::class,
        'sales' => App\GraphQL\Queries\Sale\SalesQuery::class,
        'payment' => App\GraphQL\Queries\Payment\PaymentQuery::class,
        'payments' => App\GraphQL\Queries\Payment\PaymentsQuery::class,
        'tip' => App\GraphQL\Queries\Tip\TipQuery::class,
        'tips' => App\GraphQL\Queries\Tip\TipsQuery::class,
      ...
      'mutation' => [
        ...
        'editUser' => App\GraphQL\Mutations\User\EditUserMutation::class,
        ...
        'editStore' => App\GraphQL\Mutations\Store\EditStoreMutation::class,
        'deleteStore' => App\GraphQL\Mutations\Store\DeleteStoreMutation::class,

        //Employee
        'createEmployee' => App\GraphQL\Mutations\Employee\CreateEmployeeMutation::class,
        'editEmployee' => App\GraphQL\Mutations\Employee\EditEmployeeMutation::class,
        'deleteEmployee' => App\GraphQL\Mutations\Employee\DeleteEmployeeMutation::class,

        //Sale
        'createSale' => App\GraphQL\Mutations\Sale\CreateSaleMutation::class,
        'editSale' => App\GraphQL\Mutations\Sale\EditSaleMutation::class,
        'deleteSale' => App\GraphQL\Mutations\Sale\DeleteSaleMutation::class,

        //Payment
        'createPayment' => App\GraphQL\Mutations\Payment\CreatePaymentMutation::class,
        'editPayment' => App\GraphQL\Mutations\Payment\EditPaymentMutation::class,
        'deletePayment' => App\GraphQL\Mutations\Payment\DeletePaymentMutation::class,

        //Tip
        'createTip' => App\GraphQL\Mutations\Tip\CreateTipMutation::class,
        'editTip' => App\GraphQL\Mutations\Tip\EditTipMutation::class,
        'deleteTip' => App\GraphQL\Mutations\Tip\DeleteTipMutation::class,
      ...
      'types' => [
        ...
        'Sale' => App\GraphQL\Types\SaleType::class,
